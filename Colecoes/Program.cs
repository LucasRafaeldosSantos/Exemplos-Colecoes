...
namespace Colecoes
{
    class Program
    {
        ...
        {
            int[] arrayNumeros = new int[10] { 8, 3, 5, 12, 25, 55, 24, 55, 5, 12};

            var minimo = arrayNumeros.Min();
            var maximo = arrayNumeros.Max();
            var medio = arrayNumeros.Average();
            var soma = arrayNumeros.Sum();
            var arrayUnico = arrayNumeros.Distinct();
 ...
 // var numerosParesQuery =
            ...
            // estados[valorProcurado] = "PR - Teste de atualização";
...
// Queue<string> fila = new Queue<string>();
            ...
            // System.Console.WriteLine($"Quantidade de elmentos na lista: {estados.Count}");
            ...
            // int[] array = new int[5] { 15, 3, 5, 55, 25 };
            ...
            // System.Console.WriteLine($"Capacidade do array após redimensionamento: {array.Length}");
        ...
        //    }
            ...
            // else
            // {
            //     System.Console.WriteLine("Existe valores menos que {0}", valorProcurado);
            // }
